  ...
  render() {
    return (
      <Row>
        ...
        <QuoteBlock quote='"Hands down the best developer I have ever had the pleasure of working with!"' cite='Some Dude' colorSet='quote-color-1' />
        <SkillsList />
        <LearningList />
        <QuoteBlock quote='"Hands down the best developer I have ever had the pleasure of working with!"' cite='Some Dude' colorSet='quote-color-2' />
